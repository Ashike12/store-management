...
export const textVariants = cva('font-sfPro inline', {
  variants: {
    variant: {
      ...
      CardTitle: 'font-[510] text-[12px] leading-[18px]',
      ...
      ComponentButtonMedium: 'font-[510] text-[13px] leading-[24px]',
...
export default function TextWrapper({
  ...
  return <span className={cn(textVariants({variant, className}))}>{text}</span>;
}
